...
class GetLoanTransactionByLoanId extends BaseRequest
{
    ...
    {
        $returnBody = $this->loanTransactionService->getById($this->args['id']);
        $returnBody['installment'] = $this->installmentService->getAllByLoanTransactionId($this->args['id']);
        $statusCode = 200;
